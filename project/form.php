...
<div style="margin-left:200px; padding-left:330px;margin-top: 0px; font-size:20px; padding-top:20px;" class="container">
	<div class="row col-md-6 col-md-offset-3">
		<div class="panel panel-primary">
			<div class="panel-heading text-center">
				<h1 style="margin-top: 50px;">REGISTRATION FORM</h1>
			</div>
			...
			<div class="panel-footer text-center">
				<small>&copy;Avengers & Autos</small>
			</div>
		</div>
	</div>
</div>
